...
const suffixList = [
   ...
   ["bork"],
   ["bos", "bosch"], 
   /* De etymologische betekenis van het toponiem broek is 'moerassig land' */
   ...
   ["kerk", "kerke", "kerken", "klooster", "parochie", "kerspel", "karspel", "kerspil", "carspel", "carspil"], // middelnederlandse benaming voor een kerkgemeente, een parochie of een onderdeel daarvan.
   ...
   ["tricht", "trecht", "drecht", "dracht"], 
   ["veen"],
   ["veer"],
   ["veld"],
   ["vliet"], // Vliet is Oudnederlands voor een watergang.
   ["voorde", "foort", "voort", "vorden", "voerde", "forde", "fort", "vort", "voirt", "furt"], // // voorde (Middelnederlands: vort of vorda), drecht (in Friesland en soms in West-Friesland ook dracht genoemd), trecht of tricht is een doorwaadbare plaats, meestal in een beek of rivier.
